...
let InteractableImageGenerator = (() => {
    ...
    var InteractableImageGenerator = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.snap3DFactory = (__runInitializers(this, _instanceExtraInitializers), this.snap3DFactory);
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("InteractableSnap3DGenerator", this.enableLogging || this.enableLoggingLifecycle, true);
