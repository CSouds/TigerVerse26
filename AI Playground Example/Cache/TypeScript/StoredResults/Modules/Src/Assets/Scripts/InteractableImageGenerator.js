...
let InteractableImageGenerator = (() => {
    ...
    var InteractableImageGenerator = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.modelProvider = (__runInitializers(this, _instanceExtraInitializers), this.modelProvider);
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("InteractableImageGenerator", this.enableLogging || this.enableLoggingLifecycle, true);
            if (this.enableLoggingLifecycle)
                this.logger.debug("LIFECYCLE: onAwake()");
            this.imageGenerator = new ImageGenerator_1.ImageGenerator(this.modelProvider, this.logger);
