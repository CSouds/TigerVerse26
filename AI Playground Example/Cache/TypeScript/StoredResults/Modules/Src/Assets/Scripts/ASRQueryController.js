...
let ASRQueryController = (() => {
    ...
    var ASRQueryController = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.button = (__runInitializers(this, _instanceExtraInitializers), this.button);
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("ASRQueryController", this.enableLogging || this.enableLoggingLifecycle, true);
