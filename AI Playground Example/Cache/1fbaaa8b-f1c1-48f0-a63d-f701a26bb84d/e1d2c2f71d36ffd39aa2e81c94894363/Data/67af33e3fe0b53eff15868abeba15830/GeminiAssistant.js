...
const VideoController_1 = require("RemoteServiceGateway.lspkg/Helpers/VideoController");
...
let GeminiAssistant = (() => {
    ...
    var GeminiAssistant = _classThis = class extends _classSuper {
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("GeminiAssistant", this.enableLogging || this.enableLoggingLifecycle, true);
